package org.panda.zipkin.brave;
...
public class App {
    public static void main(String[] args) {
        Sender sender = OkHttpSender.create("http://localhost:10118/api/v2/spans");
        AsyncReporter asyncReporter = AsyncReporter.builder(sender).closeTimeout(500, TimeUnit.MILLISECONDS)
                .build(SpanBytesEncoder.JSON_V2);

        Tracing tracing = Tracing.newBuilder().localServiceName("tracer-demo").spanReporter(asyncReporter)
